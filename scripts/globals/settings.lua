...
MINING_BREAK_CHANCE     = 0.15; -- % chance for the pickaxe to break during mining.  Set between 0 and 1.
...
COFFER_MAX_ILLUSION_TIME = 900;  -- 1 hour
COFFER_MIN_ILLUSION_TIME = 300;  -- 30 minutes
CHEST_MAX_ILLUSION_TIME  = 900;  -- 1 hour
...
FrigiciteDuration = 120; -- When OldSChoolG2 is enabled, this is the time (in seconds) you have from killing Boreal NMs to click the "???" target.
